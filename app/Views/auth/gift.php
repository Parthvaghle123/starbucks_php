...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet">
    ...
    <link rel="stylesheet" href="<?= base_url('css/item1.css') ?>">
  ...
  <body>
    ...
    <div class="Herosection_1">
      <div class="container">
        ...
        <div style="text-align: center; margin: 20px 0;">
          ...
          <button onclick="showDebugInfo()" class="btn btn-warning">Show Debug Info</button>
        </div> -->
    ...
    <script src="<?= base_url('js/item1.js') ?>"></script>
    ...
    <script>
      ...
      function showDebugInfo() {
        ...
        const debugInfo = {
          ...
          messageBoxStyle: messageBox ? messageBox.style.display : 'null'
        };
